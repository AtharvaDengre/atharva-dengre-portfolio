        ...
        <div className="hero-grid grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-12 items-center">
          ...
          <div className="hero-visual flex justify-center relative">
            <div className="glass-command-wrapper relative w-full max-w-[440px] p-[15px]" id="avatarCard" ref={cardRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
              ...
              {/* Top Floating Badge */}
              <div className="glass-badge badge-top-right float-anim-1 absolute -top-3 -right-2 z-30 bg-[rgba(18,9,24,0.95)] border border-[rgba(255,45,75,0.5)] backdrop-blur-xl px-3.5 py-2 rounded-xl flex items-center gap-2.5 shadow-[0_15px_35px_rgba(0,0,0,0.9)] whitespace-nowrap [transform:translateZ(25px)] [backface-visibility:hidden]">
                <i className="fa-solid fa-globe badge-icon text-lg text-accent-red"></i>
                <div>
                  <div className="badge-title font-display text-[12.5px] font-bold text-text-main">Relocation-Ready</div>
                  <div className="badge-sub font-mono text-[9.5px] text-text-faint">Dubai · Singapore · Malaysia · EU</div>
                </div>
              </div>

              {/* Bottom Floating Badge */}
              <div className="glass-badge badge-bottom-left float-anim-2 absolute -bottom-3 -left-2 z-30 bg-[rgba(18,9,24,0.95)] border border-[rgba(157,78,221,0.5)] backdrop-blur-xl px-3.5 py-2 rounded-xl flex items-center gap-2.5 shadow-[0_15px_35px_rgba(0,0,0,0.9)] whitespace-nowrap [transform:translateZ(25px)] [backface-visibility:hidden]">
                <i className="fa-solid fa-microchip badge-icon text-lg text-accent-purple"></i>
                <div>
                  <div className="badge-title font-display text-[12.5px] font-bold text-text-main">SAP Joule &amp; watsonx</div>
                  <div className="badge-sub font-mono text-[9.5px] text-text-faint">Assist-to-Human AI Triage</div>
                </div>
              </div>

      ...
      <div className="hero-container max-w-[1240px] mx-auto px-7 w-full">
        <div className="hero-grid grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-12 items-center">
          ...
          <div className="hero-content">
            <div className="status-badge-group flex flex-col items-start gap-2.5 mb-6 pt-5">
          ...
          <div className="hero-visual flex justify-center relative">
            <div className="glass-command-wrapper relative w-full max-w-[440px] p-[15px]" id="avatarCard" ref={cardRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
              ...
              {/* Top Floating Badge */}
              <div className="glass-badge badge-top-right float-anim-1 absolute -top-6 -right-4 sm:-top-8 sm:-right-6 z-30 bg-[rgba(18,9,24,0.95)] border border-[rgba(255,45,75,0.5)] backdrop-blur-2xl px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl flex items-center gap-2.5 shadow-[0_15px_35px_rgba(0,0,0,0.9)] whitespace-nowrap">
              ...
              <div className="glass-badge badge-bottom-left float-anim-2 absolute -bottom-6 -left-4 sm:-bottom-8 sm:-left-6 z-30 bg-[rgba(18,9,24,0.95)] border border-[rgba(157,78,221,0.5)] backdrop-blur-2xl px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl flex items-center gap-2.5 shadow-[0_15px_35px_rgba(0,0,0,0.9)] whitespace-nowrap">
                <i className="fa-solid fa-microchip badge-icon text-lg sm:text-xl text-accent-purple"></i>
                <div>
                  <div className="badge-title font-display text-[12px] sm:text-[13px] font-bold text-text-main">SAP Joule &amp; watsonx</div>
                  <div className="badge-sub font-mono text-[9px] sm:text-[10px] text-text-faint">Assist-to-Human AI Triage</div>
                </div>
              </div>
